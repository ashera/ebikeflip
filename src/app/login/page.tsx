...
export default async function LoginPage({
  ...
  return (
    <div className="relative flex flex-1 items-center justify-center overflow-hidden bg-gradient-to-b from-ocean-100 via-sand-50 to-sand-100 px-6 py-16 dark:from-ocean-950 dark:via-ocean-900 dark:to-ocean-950">
      <EbikeSketch
        className="pointer-events-none absolute -left-10 bottom-10 -z-0 h-44 w-auto -rotate-6 text-ocean-700 opacity-[0.10] dark:text-ocean-200 dark:opacity-[0.14]"
      />
      <EbikeSketch
        className="pointer-events-none absolute -right-10 top-10 -z-0 h-36 w-auto rotate-3 text-concrete-700 opacity-[0.08] dark:text-sand-100 dark:opacity-[0.10]"
      />
